    ...
    var handleIntro = function () {
        ...
        setTimeout(function () {
            var unique_id = $.gritter.add({
                ...
                text: 'PTS is a brand new Responsive Admin Dashboard Template you have always been looking for!',
        ...
        setTimeout(function () {
            var unique_id = $.gritter.add({
                ...
                title: 'Buy PTS!',
                // (string | mandatory) the text inside the notification
                text: 'PTS comes with a huge collection of reusable and easy customizable UI components and plugins. Buy PTS today!',
                // (string | optional) the image to display on the left
                image: './assets/img/avatar1.jpg',
                // (bool | optional) if you want it to fade out on its own or just sit there
                sticky: true,
        ...
        setTimeout(function () {
            ...
            var unique_id = $.gritter.add({
                ...
                title: 'Customize PTS!',
                // (string | mandatory) the text inside the notification
                text: 'PTS allows you to easily customize the theme colors and layout settings.',
                // (string | optional) the image to display on the left
